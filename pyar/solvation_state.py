...
class SolvationRunState:
    ...
    def create(cls, root_directory, request, current_seeds):
        """Create and persist state for a fresh solvation calculation."""
        data = {
    ...
    def current_seed_molecules(self):
        """Load the seed geometries to be used for the next solvation cycle."""
    ...
    def complete_cycle(self, cycle_number, selected_molecules):
        """Persist the completed cycle and update the seed pool for the next one."""
