...
This module defines :class:`~pyar.core.molecule.Molecule`, a lightweight domain
...
from pyar.core import geometry as molecule_geometry
from pyar.io import xyz as molecule_io
import pyar.molecule_merge as molecule_merge
from pyar.io.xyz import XYZParseError
...
class Molecule(object):
    ...
    def __init__(
        ...
        self.covalent_radius = [atomic_data.covalent_radius[n] for n in self.atoms_list]
        self.vdw_radius = [atomic_data.vdw_radius[n] for n in self.atoms_list]
